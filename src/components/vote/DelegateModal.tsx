      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          <AutoColumn gap="lg" justify="center">
            ...
            <TYPE.body>Earned BTRUST tokens represent voting shares in BTRUST governance.</TYPE.body>
            <TYPE.body>
              You can either vote on each proposal yourself or delegate your votes to a third party.
            </TYPE.body>
            <TYPE.body>
              Note that you would need to have ETH tokens in your wallet to pay for gas costs for this delegation/self-delegation transaction.
            </TYPE.body>
